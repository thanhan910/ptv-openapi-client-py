    ...
    def make_instance(self, include_optional) -> V3BulkDeparturesRequest:
        ...
        if include_optional:
            return V3BulkDeparturesRequest(
                requests = [
                    ptv_openapi_client.models.v3/stop_departure_request.V3.StopDepartureRequest(
                        route_type = 0, 
                        stop_id = 0, 
                        max_results = 0, 
                        gtfs = True, 
                        route_directions = [
                            ptv_openapi_client.models.v3/stop_departure_request_route_direction.V3.StopDepartureRequestRouteDirection(
                                route_id = '', 
                                direction_id = 0, 
                                direction_name = '', )
                            ], )
