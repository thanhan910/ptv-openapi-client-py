    ...
    def make_instance(self, include_optional) -> V3BulkDeparturesResponse:
        ...
        if include_optional:
            return V3BulkDeparturesResponse(
                responses = [
                    ptv_openapi_client.models.v3/bulk_departures_update_response.V3.BulkDeparturesUpdateResponse(
                        departures = [
                ...
                stops = {
                    'key' : ptv_openapi_client.models.v3/bulk_departures_stop_response.V3.BulkDeparturesStopResponse(
                        stop_name = '', 
                        stop_id = 56, 
                        stop_latitude = 1.337, 
                ...
                runs = [
                    ptv_openapi_client.models.v3/run.V3.Run(
                        run_id = 56, 
                        run_ref = '', 
                        route_id = 56, 
                        route_type = 56, 
                ...
                directions = [
                    ptv_openapi_client.models.v3/direction.V3.Direction(
                        direction_id = 56, 
                        direction_name = '', 
                        route_id = 56, 
                        route_type = 56, )
