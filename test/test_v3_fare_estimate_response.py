    ...
    def make_instance(self, include_optional) -> V3FareEstimateResponse:
        ...
        if include_optional:
            return V3FareEstimateResponse(
                fare_estimate_result_status = ptv_openapi_client.models.v3/fare_estimate_result_status.V3.FareEstimateResultStatus(
                    status_code = 56, 
                    message = '', ),
                fare_estimate_result = ptv_openapi_client.models.v3/fare_estimate_result.V3.FareEstimateResult(
                    is_early_bird = True, 
                    is_journey_in_free_tram_zone = True, 
                    is_this_weekend_journey = True, 
                    zone_info = ptv_openapi_client.models.v3/zone_info.V3.ZoneInfo(
                        min_zone = 56, 
                        max_zone = 56, 
                        unique_zones = [
                            56
                    ...
                    passenger_fares = [
                        ptv_openapi_client.models.v3/passenger_fare.V3.PassengerFare(
                            passenger_type = '', 
