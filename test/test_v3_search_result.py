    ...
    def make_instance(self, include_optional) -> V3SearchResult:
        ...
        if include_optional:
            return V3SearchResult(
                stops = [
                    ptv_openapi_client.models.v3/result_stop.V3.ResultStop(
                        stop_distance = 1.337, 
                        stop_suburb = '', 
                        route_type = 56, 
                        routes = [
                            ptv_openapi_client.models.v3/result_route.V3.ResultRoute(
                                route_name = '', 
                                route_number = '', 
                                route_type = 56, 
                                route_id = 56, 
                                route_gtfs_id = '', 
                                route_service_status = ptv_openapi_client.models.v3/route_service_status.V3.RouteServiceStatus(
                                    description = '', 
                ...
                outlets = [
                    ptv_openapi_client.models.v3/result_outlet.V3.ResultOutlet(
